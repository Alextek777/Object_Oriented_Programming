...
MainWindow::MainWindow()
{
    ...
    setWindowIcon(QPixmap(":/img/imgFiles/new file.png"));
    setWindowTitle(tr("MDI Editor"));
    QTimer::singleShot(0, this, SLOT(loadFiles()));


    QDockWidget *dock = new QDockWidget("Documents",mdiArea);
    dock->resize(400, 700);
    ...
    documentList = new QDockWidget;
    this->addDockWidget(Qt::RightDockWidgetArea,documentList);

    listModel = new QStringListModel;
    listView = new QListView;
    listView->setModel(listModel);
    documentList->setWidget(listView);
    fileNameList << "document1.txt";
...
void MainWindow::createActions()
{
    ...
    newAction->setIcon(QIcon(":/img/imgFiles/new file.png"));
    newAction->setShortcut(QKeySequence::New);
    newAction->setStatusTip(tr("Create a new file"));
    connect(newAction, SIGNAL(triggered()), this, SLOT(newFile()));

    openAction = new QAction(tr("&Open..."), this);
    openAction->setIcon(QIcon(":/img/imgFiles/open file.png"));
    openAction->setShortcut(QKeySequence::Open);
    openAction->setStatusTip(tr("Open an existing file"));
    connect(openAction, SIGNAL(triggered()), this, SLOT(open()));

    saveAction = new QAction(tr("&Save"), this);
    saveAction->setIcon(QIcon(":/img/imgFiles/save file.png"));
    ...
    cutAction->setIcon(QIcon(":/img/imgFiles/cut.png"));
    ...
    copyAction->setIcon(QIcon(":/img/imgFiles/copy.png"));
    ...
    pasteAction->setIcon(QIcon(":/img/imgFiles/paste.png"));
